    ...
    <div className="Hawaiian col-4">
      <div className="card">
        ...
        <div className="card-body">
          ...
          <p className="card-text">We know, you think this is gross. But try this once and we swear you'll be hooked on this pineapple and ham pizza. It will blow your mind !!!</p>
        </div>
